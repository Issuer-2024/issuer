...
from app.v2.content.public_opinion import get_public_opinion_activity_data
...
def create_content(q: str, background_task):
    ...
    public_opinion_activity_data = get_public_opinion_activity_data(q)
    ...
    result = Content(title, created_at, estimated_search_amount, public_opinion_activity_data, table_of_contents, body)
